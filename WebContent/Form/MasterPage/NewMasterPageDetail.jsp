...
<body>
	<!-- HEADER -->
	<jsp:include page="/Form/MasterPage/Header.jsp"></jsp:include>
	<!--/HEADER -->

	<!-- PAGE -->
	<section id="page">
		<!-- SIDEBAR -->
		<jsp:include page="/Form/MasterPage/SideBarMenu.jsp"></jsp:include>
		<!-- /SIDEBAR -->
		<div id="main-content">
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<!-- PAGE HEADER-->
						<div class="row">
							<div class="col-sm-12" style="padding: 0px;" id="MenuHeader">
								<!-- navbar-tab -->
								<jsp:include page="/Form/MasterPage/MenuHeader.jsp"></jsp:include>
								<!-- /navbar-tab -->
							</div>
						</div>
						<!-- /PAGE HEADER -->
	...
	<jsp:include page="/Form/Common/overlay.jsp"></jsp:include>
